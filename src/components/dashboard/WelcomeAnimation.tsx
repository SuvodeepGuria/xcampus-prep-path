...
export const WelcomeAnimation: React.FC<WelcomeAnimationProps> = ({
  ...
  const firstMessage = `Welcome ${userName}! Excited to kick off this journey together?`;
  const secondMessage = 'Real experiences, real questions, real guidance – everything you need to ace your interview.';
